...
BEGIN
    ...
    PROCESS (CLOCK) -- output D flip-flops generation
    BEGIN
    ...
    ctrl <= out_0 & ed_out & out_1; -- bits needed to process the vulnerability

    ack_out <= ack_0 AND ack_a; -- acknowledge
    count_0 <= '1' WHEN ack_0 = '0' ELSE
        '0'; -- toggle LFSR serial load counting
END behavioral;