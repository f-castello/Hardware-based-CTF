...
HD_PWD='Z:/Documents/Embedded/CyberSec/Hardware-based-CTF/VHDL/VHDL.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log BlockCipher.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source BlockCipher.tcl
